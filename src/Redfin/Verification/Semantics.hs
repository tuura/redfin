-----------------------------------------------------------------------------
-- |
-- Module      :  Redfin.Verification.Semantics
...
module Redfin.Verification.Semantics (
    ...
    Redfin.Verification.Semantics.and, Redfin.Verification.Semantics.or,
    Redfin.Verification.Semantics.xor, Redfin.Verification.Semantics.not,
