...
We can write programs in the untyped REDFIN assembly, or in a
typed higher-level expression language. The former allows engineers to
hand-craft highly optimised programs under tight resource
constraints, but the latter brings type-safety and faster prototyping. We start
...
This allows us to discover a problem in our energy estimation program.
...
and formulate a corresponding theorem.
...
\noindent
We modify time and power constraints accordingly:
...
\noindent
We then rerun Z3 (now on 134 SMT clauses) and get the desired outcome in 4.8s:
...
\noindent
To support the development of hand-crafted code, we use Z3 to check the
