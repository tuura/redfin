...
In this experience report, we present a verification approach designed to help
spacecraft engineers to reduce the effort required for formal verification of
